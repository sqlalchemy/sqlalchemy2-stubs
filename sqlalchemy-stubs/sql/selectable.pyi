...
class ReturnsRows(roles.ReturnsRowsRole, ClauseElement):
    ...
    @property
    def exported_columns(self) -> ColumnCollection[Any]: ...
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    def columns(self) -> ImmutableColumnCollection[Any]: ...
    @property
    def entity_namespace(self) -> ImmutableColumnCollection[Any]: ...
    @util.memoized_property
    def primary_key(self) -> ColumnSet[Any]: ...
    @util.memoized_property
    def foreign_keys(self) -> Set[ForeignKey]: ...
    @util.memoized_property
    def c(self) -> ImmutableColumnCollection[Any]: ...
...
class FromGrouping(GroupedElement, FromClause):
    ...
    @property
    def columns(self) -> ImmutableColumnCollection[Any]: ...  # type: ignore[override]
    @property
    def primary_key(self) -> ColumnSet[Any]: ...  # type: ignore[override]
    @property
...
class SelectBase(
    ...
    is_select: bool = ...
    @property
    def selected_columns(self) -> ImmutableColumnCollection[Any]: ...
    @property
    def exported_columns(self) -> ImmutableColumnCollection[Any]: ...
    @property
    def c(self) -> ColumnCollection[Any]: ...
    @property
...
class Select(
    ...
    @HasMemoized.memoized_attribute
    def selected_columns(self) -> ImmutableColumnCollection[Any]: ...  # type: ignore[override]
    def self_group(
