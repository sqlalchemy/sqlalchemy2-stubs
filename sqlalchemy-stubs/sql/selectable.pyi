...
_GenerativeSelect = TypeVar("_GenerativeSelect", bound=GenerativeSelect)
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def limit(self: _GenerativeSelect, limit: Any) -> _GenerativeSelect: ...
    def fetch(
        self: _GenerativeSelect, count: Any, with_ties: bool = ..., percent: bool = ...
    ) -> _GenerativeSelect: ...
    def offset(self: _GenerativeSelect, offset: Any) -> _GenerativeSelect: ...
    def slice(self: _GenerativeSelect, start: Any, stop: Any) -> _GenerativeSelect: ...
    def order_by(self: _GenerativeSelect, *clauses: Any) -> _GenerativeSelect: ...
    def group_by(self: _GenerativeSelect, *clauses: Any) -> _GenerativeSelect: ...
...
_Select = TypeVar("_Select", bound=Select)
...
class Select(
    ...
    def filter(self: _Select, *criteria: Any) -> _Select: ...
    def filter_by(self, **kwargs: Any) -> _Select: ...
    @property
    ...
    def outerjoin(
        self: _Select, target: Any, onclause: Optional[Any] = ..., full: bool = ...
    ) -> _Select: ...
    @property
    def froms(self): ...
    @property
    ...
    def add_columns(self: _Select, *columns: Any) -> _Select: ...
    def column(self: _Select, column: Any) -> _Select: ...
    def reduce_columns(self: _Select, only_synonyms: bool = ...) -> _Select: ...
    def with_only_columns(self: _Select, *columns: Any) -> _Select: ...
    @property
    def whereclause(self): ...
    def where(self: _Select, *whereclause: Any) -> _Select: ...
    def having(self: _Select, having: Any) -> _Select: ...
    def distinct(self: _Select, *expr: Any) -> _Select: ...
    def select_from(self: _Select, *froms: Any) -> _Select: ...
    def correlate(self: _Select, *fromclauses: Any) -> _Select: ...
    def correlate_except(self: _Select, *fromclauses: Any) -> _Select: ...
    def selected_columns(self): ...
    def self_group(self, against: Optional[Any] = ...): ...
...
_ScalarSelect = TypeVar("_ScalarSelect", bound=ScalarSelect)
...
class ScalarSelect(roles.InElementRole, Generative, Grouping):
    ...
    c: Any = ...
    def where(self: _ScalarSelect, crit: Any) -> _ScalarSelect: ...
    def self_group(self, **kwargs: Any): ...
    def correlate(self: _ScalarSelect, *fromclauses: Any) -> _ScalarSelect: ...
    def correlate_except(self: _ScalarSelect, *fromclauses: Any) -> _ScalarSelect: ...
...
_TextualSelect = TypeVar("_TextualSelect", bound=TextualSelect)
...
class TextualSelect(SelectBase):
    ...
    def selected_columns(self): ...
    def bindparams(self: _TextualSelect, *binds: Any, **bind_as_values: Any) -> _TextualSelect: ...
